    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_Delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('SKU_id', models.CharField(default='100001', max_length=128, primary_key=True, serialize=False, verbose_name='商品SKU编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_Delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('SPU_id', models.CharField(default='10000', max_length=128, primary_key=True, serialize=False, verbose_name='商品SPU编号')),
